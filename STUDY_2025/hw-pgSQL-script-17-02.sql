do $$
begin
    raise notice 'Скрипт для создания тестовых данных генерации содержимого таблиц yulya.employees и yulya.measurment_input_params';
    declare
        var_i integer;
        var_j integer;
    ...
    raise notice 'Тестовые данные успешны добавлены';
end $$;
